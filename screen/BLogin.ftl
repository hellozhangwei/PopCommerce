...
<div class="form-signin"><div class="tab-content">
    ...
    <div id="reset" class="tab-pane">
        <form method="post" action="${sri.buildUrl("resetPassword").url}">
    ...
    <div id="change" class="tab-pane">
        <form method="post" action="${sri.buildUrl("changePassword").url}">
            <p class="text-muted text-center">Enter details to change your password</p>
            <input type="text" name="username" value="${(ec.getWeb().getErrorParameters().get("username"))!""}" placeholder="Username" required="required" class="form-control top">
            <input type="password" name="oldPassword" placeholder="Current Password" required="required" class="form-control middle">
    ...
    <div id="new-account" class="tab-pane">
        <form name="createAccount" id="createAccount" method="post" action="${sri.buildUrl("createAccount").url}">
            ...
            <button class="btn btn-lg btn-success btn-block" type="submit">Request Account</button>
        </form>
    </div>
